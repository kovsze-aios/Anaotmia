...
**Action:** Standardize on `focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-400 dark:focus-visible:ring-zinc-600` across all custom interactive components to ensure consistent keyboard accessibility.
## 2026-08-26 - Hide repetitive content in Link wrappers
**Learning:** When card-based layouts are wrapped in <Link> components, screen readers will read all inner text. Purely decorative icons and generic repetitive CTA text (like 'Przejdź do...') create a noisy and repetitive screen reader experience. Adding aria-hidden to these elements allows users to focus on the meaningful title and description.
**Action:** Always apply `aria-hidden="true"` to decorative icons and repetitive generic CTAs inside large clickable cards to improve accessibility.
