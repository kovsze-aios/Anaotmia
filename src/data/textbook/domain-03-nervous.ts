...
export const nervous: TextbookDomain = {
  ...
  "sections": [
    ...
    },
    {
      ...
      "academic_detail": "Do zwojów podstawy (jąder podstawnych) układu pozapiramidowego należą m.in. jądro ogoniaste (nucleus caudatus) i jądro czerwienne (nucleus ruber). Układ pozapiramidowy odpowiada za regulację napięcia mięśniowego oraz ruchy automatyczne.\n\nMiędzymózgowie składa się z: wzgórza (thalamus), podwzgórza (hypothalamus), nadwzgórza (epithalamus). Podwzgórze łączy się z przednim płatem przysadki poprzez naczynia wrotne i aksony. Nadwzgórze zawiera szyszynkę (corpus pineale). W obrębie międzymózgowia znajduje się III komora mózgu.\n\nZe źródeł:\npodstawy w ziarenko ciałka podstawowego\n(corpusculum basale), utworzone przez centriole.\nJądro komórkowe\nWielkość jądra (nucleus) jest wprost proporcjonalna do wielkości ey-\ntoplazmy. Większość komórek ma jedno jądro, choć znane są także ko-\nmórki dwu- lub wielojądrzaste (wątroba, chrząstka, osteoklasty).\nUmiejscowienie jądra w komórce jest zmienne, najczęściej jest ono po-\nłożone w najbardziej aktywnej części cytoplazmy.\nOd zewnątrz jądro otoczone jest błoną jądrową. Wnętrze jądra wy-\npełnia tzw. nukleoplazm a, która w zależności od rodzaju komórki\njest mniej lub bardziej jednorodna. Składa się ona z elementów włók-\nnistych i ziarnistych zawieszonych w jednorodnej substancji, zwanej\nkariolimfą lub sokiem jądrowym.Wewnątrzwiększościjąder\nznajduje się ponadto jąderko (p. dalej). Błon a jądro w a (caryolem-\nma) stanowi granicę dwóch obszarów komórki różniących się znacznie\npod względem fizykochemicznym.\n. Elektronogram jadra komórkowego, w Fawcetta.\n88\n82\n\n--- STRONA 27 ---\nników między cytoplazmą a jądrem. Liczba porów na 1 μm² powierz-\nchni wynosi 40—80. W licznych komórkach ssaków pory stanowią 10%\npowierzchni błony jądrowej. Pory otoczone są wewnątrz cylindryczną\nPars\nścianką, tzw. pierścieniem (anulus); najczęściej są przesłonięte\namorpha\nprzez cienką blaszkowatą przeponę. Pierścienie otaczające pory są po-\nłączone z sobą delikatnym pasmowatym filamentem. Przez pory moga\nprzedostawać się cząsteczki mniejsze od średnicy poru, tj. poniżej 60,0\nnm. Czasem pory wypełnione są gęstą elektronowo substancją, praw-\ndopodobnie białkiem. Przypuszcza się, że odgrywa ono jakąś rolę w re-\ngulowaniu ich przepuszczalriości. Na stopień przepuszczalności błony\nlad  kwad     tkw\npowierzchni. Jest ona zależna od wieku, rodzaju komórki i stopnia jej\nzróżnicowania (ryc. 23).\nCzynnikiem wpływającym na wnikanie różnych substancji z jądra\nNucleolonema\ndo cytoplazmy i w kierunku odwrotnym jest kontakt błony jądrowej\nz siateczką śródplazmatyczną.\nJądra w większości komórek (z wyjątk",
    ...
    },
    {
      ...
      "academic_detail": "W śródmózgowiu znajduje się wodociąg mózgu (aqueductus cerebri), który łączy III i IV komorę. Śródmózgowie zawiera wzgórki górne (colliculi superiores — droga wzrokowa), wzgórki dolne (colliculi inferiores — droga słuchowa), jądro czerwienne, istotę czarną (substantia nigra) oraz jądra nerwów czaszkowych III (okoruchowy) i IV (bloczkowy).\n\nW moście znajdują się jądra nerwów czaszkowych V (trójdzielny), VI (odwodzący), VII (twarzowy), VIII (przedsionkowo-ślimakowy). W rdzeniu przedłużonym znajdują się jądra nerwów: IX (językowo-gardłowy), X (błędny), XI (dodatkowy), XII (podjęzykowy).\n\nW rdzeniu przedłużonym mieszczą się ośrodki czynności życiowych: oddechowy, krążenia i sercowy. Dno IV komory ograniczone jest przez most i rdzeń przedłużony, a dach tworzy móżdżek.\n\nMóżdżek zbudowany jest z kory (istota szara) na zewnątrz i ciała rdzeniastego (istota biała) z jądrami móżdżku wewnątrz. Łączy się z resztą mózgowia poprzez konary (peduncles): górny (do śródmózgowia), środkowy (do mostu) i dolny (do rdzenia przedłużonego). Funkcje móżdżku: stabilizacja, regulacja napięcia mięśniowego, koordynacja ruchowa.\n\nZe źródeł:\nmózgu wynosi 85%,\ngicznym. Mają one złożoną budowę chemiczną. Składają się z cukru (rybozy lub dezo-\naw   s          (    %)\nksyrybozy), zasad azotowych (puryn lub pirymidyn) i kwasu fosforowego. Kwasy nukle-\ninowe są polinukleotydami o długich cząsteczkach powstałych przez połączenie wielu\nSkładnikimineralne cytoplazmy występują pod postacią soli lub w połączeniu\nnukleotydów.\nz białkami, cukrowcami i lipidami. Sole zdysocjowane na aniony (np. Cl-) i kationy (np.\nNa, K) odgrywają ważną rolę w utrzymywaniu ciśnienia osmotycznego i równowagi\nFizyczne właściwości cytoplazmy. Włókienkowe cząsteczki białka\nkwasowo-zasadowej. Stężenie poszczególnych jonów jest inne w komórkach niż w płynie\nśródtkankowym. Komórka zawiera dużo jonów K+ i Mg**, podezas gdy jony Na⁺ i Cl-\nmogą swobodnie przesuwać się, wtedy cytoplazma ma konsystencję\nwystępują głównie w płynach śródtkankowych. Dominującym anionem w komórkach\npłynną, albo wiązać ze sobą w siateczki, co nadaje jej charakter galare-\njest fosforan. Obecne tam są także pewne ilości wodoroweglanów. Jony wapniowe wystę-\ntowaty. Przejście jednego stanu w drugi jest odwracalne. Powyższy\npują we krwi i w komórkach. W kościach tworzą one w połączeniu z fosforanami i wę-\nwłókienkowo-siateczkowy układ złożony z białek i lipidów oraz kwa-\nglanami układy krystaliczne.\ns     n c\nFosf o ran y występują we krwi i w płynie tkankowym w postaci wolnych jonów, nu-\nkach między włókienkami znajduje się wodny roztwór drobnocząstecz-\nkleotydów, fosfoprotein i cukrów fosforylowych. Fosforany pierwszorzędowy (H2PO4)\nkowych składników cytoplazmy, w którym zawieszone są różne orga-\ni dwurzędowy (HPOł) tworzą układ buforowy, który stabilizuje pH krwi i płynów tkan-\nkowych. Niektóre składniki mineralne występują w postaci nie zjonizowanej, np. żelazo\nnelle komórkowe.\npołączone wiązaniem metal — wegiel w hemoglobinie, cytochromach i w niektórych in-\nnych enzymach.\nMagnez, miedź, wanad, cynk, nikiel, molibden i cyna wystąpują w ilościach ślado-\nBłony komórkow",
    ...
    },
    {
      ...
      "academic_detail": "Rdzeń kręgowy ma zgrubienia: szyjne (intumescentia cervicalis — dla splotu ramiennego) i lędźwiowe (intumescentia lumbalis — dla splotu lędźwiowego). Kończy się na poziomie L1/L2 jako nić końcowa (filum terminale) przyczepiająca się do kości guzicznej.\n\nW przekroju poprzecznym rdzenia kręgowego istota biała tworzy sznury (funiculi): przednie (funiculus anterior — włókna ruchowe), tylne (funiculus posterior — włókna czuciowe), boczne (funiculus lateralis — włókna autonomiczne/współczulne). Istota szara tworzy kształt litery H (motyl): rogi przednie (cornu anterius — włókna ruchowe), rogi tylne (cornu posterius — włókna czuciowe), rogi boczne (cornu laterale — włókna współczulne).\n\nOpony mózgowo-rdzeniowe dzielą się na trzy warstwy: opona twarda (dura mater — zewnętrzna), pajęczynówka (arachnoidea — środkowa, z ziarnistościami pajęczynówki uchodzącymi do zatoki strzałkowej górnej), opona miękka (pia mater — wewnętrzna, przylega bezpośrednio do mózgu).\n\nPłyn mózgowo-rdzeniowy (CSF) krąży w przestrzeni podpajęczynówkowej (spatium subarachnoideum). Jest produkowany przez splot naczyniówkowy (plexus choroideus) w komorach mózgu.\n\nZe źródeł:\nrdzeń w postaci podłużnego tworu zbudowanego z nadzwyczaj regu-\nzo-6-fosfataza. Enzym ten ma być zaangażowany czynnie w transpor-\nlarnie ułożonych rureczek. Na przekroju poprzecznym przypomina on\ncie przez błony, regulując tym samym metabolizm glukozy w komórce.\nniemal krystaliczny układ i wygląda jak plaster miodu. Rdzeń ten na-\nSiateczka szorstka (reticulum granulosum)występuje w róż-\nzwano nukleoidem.\nnych ilościach we wszystkich komórkach. Na zewnątrz błon leżą zia-\nPeroksysomy mają stanowić 0,3% mokrej masy komórkowej. Zawie-\nrenka średnicy ok. 15,0 nm, zwane rybosomami. Utworzone są one w\nrają one 1,4%całkowitego białka komórki macierzystej, są więc pra-\nprzeważającej części z kwasu rybonukleinowego; biorą czynny udział\nwie pięciokrotnie bogatsze w białko niż komórka, w której występują.\nw procesie syntezy białka (p. dalej) i tam będą omówione szerzej. Sia-\nBiałka peroksysomów to przede wszystkim enzymy. Z najważniejszych należy wymie-\nteczki gładka i szorstka często są z sobą w kontakcie.\nnić oksydazę D-aminokwasów, oksydazę L-alfa-hydroksymasłową, katalazę i oksydazę\nBłony szorstkie są najbardziej czynną częścią siateczki śródplazma-\ntycznej, znajdującą się w najbliższym sąsiedztwie błony jądrowej. Poza\nErgastoplazma — siateczka śródplazmatyczna szorstka.\n78\n79\n\n--- STRONA 25 ---\nmoczanową. Dla wszystkich peroksysomów najbardziej charakterystyczna jest grupa en-\ndy błon, 2) zgrupowania gestych pęcherzyków o średnicy ok. 6,0 nm,\nzymów metabolizmu nadtlenku wodoru. Do grupy tej należy oksydaza moczanowa. Nie\nściśle związanych z cysternami, 3) dużych jasnych wodniczek występu-\nleo     k        owet\nw nich nie występować. Stale występują natomiast, poza wyżej wspomnianymi enzyma-\njących na brzegach tej strefy.\nmi, grupa enzymów cyklu glikoksalowego oraz niektóre enzymy katabolizmu puryn.\nZ tych trzech części składowych strefy Golgiego najbardziej stałe są\nNadtlenek wodoru jest rozkładany przez peroksydazę glutaminową i katalazę, która sta-\nwspomniane wyżej cyste\n\nPrzekrój rdzenia kręgowego: Istota szara tworzy rogi (przednie - ruchowe, tylne - czuciowe, boczne - współczulne). Istota biała otacza ją, tworząc sznury (funiculi): przednie, boczne i tylne, zawierające drogi nerwowe (wstępujące i zstępujące).",
    ...
    },
    {
      ...
      "academic_detail": "Na przekroju poprzecznym rdzenia kręgowego istota szara tworzy charakterystyczny kształt litery H (motyla). Wyróżniamy: (a) Róg przedni (cornu anterius) — najszerszy, zawiera ciała motoneuronów α (duże, unerwiające włókna mięśniowe pozawrzecionowe) i motoneuronów γ (mniejsze, unerwiające włókna śródwrzecionowe wrzecion mięśniowych). Motoneurony są ułożone somatotopowo: przyśrodkowo — mięśnie tułowia, bocznie — mięśnie kończyn. (b) Róg tylny (cornu posterius) — węższy, zawiera neurony czuciowe, do których docierają włókna aferentne ze zwojów rdzeniowych. W istocie galaretowatej (substantia gelatinosa Rolandi) na szczycie rogu tylnego zachodzi pierwsza modulacja bólu. (c) Róg boczny (cornu laterale) — występuje tylko na poziomach Th1-L2 (współczulny) i S2-S4 (przywspółczulny), zawiera neurony przedzwojowe AUN. (d) Istota pośrednia (substantia intermedia) — między rogami przednimi i tylnymi, zawiera interneurony.\n\nIstota biała rdzenia kręgowego zorganizowana jest w trzy pary sznurów (funiculi), które zawierają drogi wstępujące (czuciowe, aferentne) i zstępujące (ruchowe, eferentne). Sznur tylny (funiculus posterior) — między rogiem tylnym a bruzdą pośrodkową tylną, zawiera pęczek smukły (fasciculus gracilis — przyśrodkowo, włókna z kończyn dolnych i dolnej połowy tułowia) i pęczek klinowaty (fasciculus cuneatus — bocznie, włókna z kończyn górnych i górnej połowy tułowia). Oba pęczki przewodzą czucie głębokie (propriocepcja świadoma), dotyk precyzyjny (dyskryminacyjny) i wibrację. Jest to droga 3-neuronowa: receptor → zwoje rdzeniowe → jądra sznurów tylnych (jądro smukłe i klinowate w rdzeniu przedłużonym) → skrzyżowanie (decussatio lemniscorum — wstęga przyśrodkowa) → wzgórze (VPL) → kora czuciowa płata ciemieniowego.\n\nSznur boczny (funiculus lateralis) — między rogiem przednim a tylnym. Zawiera: drogę korowo-rdzeniową boczną (tractus corticospinalis lateralis — ruchowa, zstępująca, 90% włókien skrzyżowanych w piramidach rdzenia przedłużonego, główna droga ruchów dowolnych), drogę rdzeniowo-wzgórzową boczną (tractus spinothalamicus lateralis — czuciowa, wstępująca, przewodzi ból i temperaturę), drogę rdzeniowo-móżdżkową tylną (Flechsiga) i przednią (Gowersa — propriocepcja nieświadoma), drogę czerwienno-rdzeniową (tractus rubrospinalis — kontrola napięcia mięśniowego), drogę oliwkowo-rdzeniową. Sznur przedni (funiculus anterior) — między rogiem przednim a szczeliną pośrodkową przednią. Zawiera: drogę korowo-rdzeniową przednią (tractus corticospinalis anterior — 10% nieskrzyżowanych włókien, dla mięśni tułowia), drogę rdzeniowo-wzgórzową przednią (tractus spinothalamicus anterior — dotyk gruby, nacisk), drogę siatkowo-rdzeniową, drogę przedsionkowo-rdzeniową (równowaga, napięcie prostowników), drogę pokrywowo-rdzeniową (odruchy wzrokowo-ruchowe).\n\nWiększość dróg w OUN ulega skrzyżowaniu (dekusacji) — włókna z prawej połowy ciała przechodzą na lewą stronę mózgowia i odwrotnie. Droga korowo-rdzeniowa boczna krzyżuje się na poziomie piramid rdzenia przedłużonego (decussatio pyramidum). Droga rdzeniowo-wzgórzowa krzyżuje się w spoidle białym rdzenia kręgowego na poziomie wejścia włókna do rdzenia (na tym samym poziomie lub 1-2 segmenty wyżej). Droga sznurów tylnych (czucie głębokie) krzyżuje się na poziomie wstęgi przyśrodkowej w rdzeniu przedłużonym. Uszkodzenie połowicze rdzenia kręgowego (zespół Brown-Séquarda) powoduje: po stronie uszkodzenia — porażenie ruchowe (droga korowo-rdzeniowa), zniesienie czucia głębokiego i wibracji (sznury tylne); po stronie przeciwnej — zniesienie czucia bólu i temperatury (droga rdzeniowo-wzgórzowa boczna, która już się skrzyżowała).\n\nZe źródeł:\nSzczegółowe badania porównawcze\nomówionych szczątków spod Pekinu oraz z Jawy doprowadziły antropologów do przeko-\nnania, że ze względu na ogromne ich podobieństwo oba znaleziska należy uznać za\nprzedstawicieli jednej i tej samej, wymarłej już formy praczłowieka (Praehomo, ro-\ndat pn       t ai\nczamy jeszcze kilka innych znalezisk pochodzących bądź sprzed I wojny światowej (Ke-\ndu     o  z t    na\nJawie (Sangiran) i w Afryce Północnej (Ternifene i Casablanca). Istnieją też znaleziska,\nktórych przynależność do rodzaju Pithecanthropus jest sporna.\n.Czaszka Homo neandertalensis z La Chapelle aux\na\nb\nSaints (²/5 nat. wielkości).\nkonstrukcja wg Weinerta (1/4 nat. wiel-\n a. Pithecanthropus erectus, re-\n b. Sinanthropus pekinensis, re-\nkonstrukcja wg Weinerta (1/4 nat. wiel-\nz górnego plejstocenu, ¿ terenów przede wszystkim Europy (Gibraltar, La Chapelle aux\nkości).\nkości).\nSaints, Le Moustier, La Ferassie, Sacco Pastore, Neandertal, Steinheim, Ehringsdorf,\nSpy, Krapina, Kiik Koba na Krymie i inne), ale poza tym z Afryki (Brocken Hill w Rode-\nCharakterystyka praczłowieka oraz jego datowanie. W wyniku szczegółowych badań\nzji, Saldanha w Afryce Płd., ewentualnie Eyasi w Tanganice) i z Azji (Ngan-Dong na\nwspomnianych wyżej przedstawicieli praczłowieka można było ustalić jego charaktery-\nJawie, Teszik-Tasz w Azji Srodkowej, Shanidar w Persji, Karmel i inne w Palestynie).\nstykę morfologiczną. Poza wspomnianą już niezwykle niską, o bardzo małej pojemności\nPrzedstawiciele człowieka pierwotnego (Homo primigenius) określani są nazwą czło-\nczęścią mózgową czaszki, której największa szerokość przypada nie na kości ciemienio-\nwieka neandertalskiego (Homo neandertalensis), od nazwy doliny Neandertal w\nwe bądź na łuskę kości skroniowej, jak to ma miejsce u człowieka współczesnego, ale —\ndorzeczu Renu, gdzie zostały znalezione klasyczne niejako szczątki przedstawiciela tej\ntak jak u małp człekokształtnych — na część sutkową tych kości, charakterystyczne dla\ngrupy, któ\n\nPrzekrój rdzenia kręgowego: Istota szara tworzy rogi (przednie - ruchowe, tylne - czuciowe, boczne - współczulne). Istota biała otacza ją, tworząc sznury (funiculi): przednie, boczne i tylne, zawierające drogi nerwowe (wstępujące i zstępujące).",
