  ...
  "sections": [
    {
      ...
      "summary": "- Podstawową **jednostką** __________ nerki jest nefron (pytanie nr 11).\n- Każda nerka zawiera około miliona nefronów, które filtrują krew **i** __________ mocz.\n- Nerki filtrują krew pod **wysokim** __________\n- W korze nerkowej znajdują się ciałka nefronu, a w **nich** __________ nerkowe."
    },
    {
      ...
      "summary": "- Nefron składa się z ciałka nerkowego (kłębuszek nerkowy otoczony torebką, dawniej zwaną torebką Bowmana) oraz układu kanalików: kanalik **kręty** __________ rzędu, pętla nefronu (dawniej pętla Henlego — kanalik prosty wyginający się o 180 stopni), kanalik kręty drugiego rzędu i cewka zbiorcza.\n- W nerkach występuje sieć **dziwna** __________ — kłębuszek nerkowy jest właśnie taką siecią.\n- Tętnica (tętnica nerkowa) rozgałęzia się → **tętniczka** __________ (afferent arteriole) → naczynia włosowate kłębuszka (glomerular capillary network) → tętniczka odprowadzająca (efferent arteriole).\n- Jest to sieć dziwna, ponieważ naczynia włosowate łączą dwie **tętniczki** __________ i odprowadzającą), a nie — jak w normalnej sieci — tętniczkę z żyłą."
    },
    {
      ...
      "summary": "- Przewód wytryskowy **ductus**( __________ uchodzi na wzgórku nasiennym (colliculus seminalis) w cewce moczowej (części sterczowej) — pytanie nr 13.\n- Męski układ rozrodczy obejmuje: jądra, **najądrza**, __________ przewody wytryskowe, gruczoł krokowy (prostata), pęcherzyki nasienne, cewkę moczową i prącie.\n- Plemniki powstają **w** __________ krętych jąder.\n- Następnie trafiają do najądrza (głowa, trzon, ogon — ogon przechodzi **w** __________"
    },
    {
      ...
      "summary": "- Prawidłowe położenie macicy **to** __________ (anteversio) i przodozgięcie (anteflexio) — pytanie nr 10.\n- U kobiet macica od przodu sąsiaduje z pęcherzem moczowym, a od **dołu** __________ w pochwę (pytanie otwarte nr 42).\n- Żeński **układ** __________ obejmuje: jajniki, jajowody, macicę, pochwę i srom.\n- Jajniki produkują komórki jajowe i hormony **estrogen**(, __________"
    },
    {
      "id": "nerki-nefron",
      ...
      "content": [],
      "recallQuestions": [],
      "summary": "- Nefron składa się z ciałka nerkowego (kłębuszek i torebka Bowmana), gdzie zachodzi **filtracja** __________ tworząca mocz pierwotny.\n- W kanalikach nerkowych zachodzi **resorpcja** i __________.",
