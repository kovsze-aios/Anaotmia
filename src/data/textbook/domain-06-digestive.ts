  ...
  "sections": [
    {
      ...
      "summary": "- Układ pokarmowy składa się z przewodu pokarmowego (rury, przez którą przemieszcza się pokarm) oraz **gruczołów** __________ takich jak wątroba i trzustka.\n- Wątroba i trzustka nie **są** __________ dla pokarmu, mimo że strawiony pokarm trafia do wątroby za pomocą krwi (żyły wrotnej).\n- Przewód pokarmowy człowieka obejmuje: jamę ustną, gardło, przełyk, żołądek, jelito **cienkie** __________ jelito czcze, jelito kręte), jelito grube (kątnica, okrężnica, esica, odbytnica) oraz odbyt.\n- Jama ustna składa się ze szpary **ust**, __________ jamy ustnej (między wargami a zębami) oraz właściwej jamy ustnej (za zębami).",
      "academic_sources": [
        {
    ...
    },
    {
      ...
      "summary": "- Wątroba jest największym gruczołem ciała (nie licząc tarczycy **jako** __________ gruczołu dokrewnego).\n- Pełni **funkcje**: __________ syntezy białek, magazynowania glikogenu, produkcji żółci.\n- Wątroba jest narządem o **podwójnym** __________\n- Krew odżywcza (prywatna) doprowadzana jest przez tętnicę wątrobową właściwą (od tętnicy wątrobowej wspólnej, która **jest** __________ pnia trzewnego).",
      "academic_sources": [
        {
          "title": "Anatomia egzamin 2026 WF",
    ...
    },
    {
      ...
      "summary": "- Tłuszcz jest jednym ze składników **pokarmowych** __________ w jelitach.\n- Tłuszcz jest lepki — krew, która odbiera substancje odżywcze w układzie żyły wrotnej, byłaby bardzo narażona **na** __________ swojej lepkości, czyli na zatory (ryzyko embolizmu).\n- Z tego powodu krew **NIE** __________ tłuszczu z jelit.\n- Tłuszcze **są** __________ wyłącznie przez układ limfatyczny.",
      "academic_sources": [
        {
          "title": "Anatomia egzamin 2026 WF",
    ...
    },
    {
      ...
      "summary": "- **Otrzewna** __________ jest największą błoną surowiczą ciała.\n- Składa się z otrzewnej ściennej (peritoneum parietale ****— __________ ściany jamy brzusznej i miednicy) i otrzewnej trzewnej (peritoneum viscerale — pokrywającej narządy).\n- Między nimi znajduje się jama otrzewnej **cavitas**( __________ wypełniona cienką warstwą płynu surowiczego (~50 ml), który zmniejsza tarcie między narządami.\n- **Narządy** __________ (pokryte otrzewną ze wszystkich stron, zawieszone na krezce): żołądek, jelito czcze i kręte, poprzecznica, esica, wątroba, śledziona.",
      "academic_sources": [
        {
          "title": "Anatomia egzamin 2026 WF",
