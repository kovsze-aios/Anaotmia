      ...
      },
      {
        ...
        content: [
          ...
          },
          {
            ...
            rows: [
              ["Liczba podziałów", "1", "2 (mejoza I + mejoza II)"],
              ["Liczba komórek potomnych", "2", "4"],
              ["Ploidia komórek potomnych", "2n (diploidalne)", "1n (haploidalne)"],
              ["Tożsamość genetyczna", "Identyczne z rodzicielską", "Unikalne (rekombinacja)"],
              ["Crossing-over", "Nie zachodzi", "Zachodzi w profazie I"],
              ["Występowanie", "Komórki somatyczne", "Komórki linii płciowej (gamety)"],
              ["Liczba podziałów DNA", "1 replikacja, 1 podział", "1 replikacja, 2 podziały"],
              ["Funkcja", "Wzrost, regeneracja", "Rozmnażanie płciowe, zmienność"],
            ],
          },
        ],
        recallQuestions: [
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          {
            type: "table",
            headers: ["Typ RNA", "Funkcja", "Lokalizacja"],
            rows: [
              ["mRNA (informacyjny)", "Niesie informację o sekwencji aminokwasów z DNA do rybosomu", "Jądro (transkrypcja) → cytoplazma (translacja)"],
              ["tRNA (transportujący)", "Przenosi aminokwasy do rybosomu i dopasowuje je do kodonu mRNA (antykodon)", "Cytoplazma"],
              ["rRNA (rybosomalny)", "Strukturalny i katalityczny składnik rybosomów (rybozym — peptydylotransferaza)", "Rybosomy (jąderko → cytoplazma)"],
              ["miRNA (mikro RNA)", "Regulacja ekspresji genów — blokowanie translacji lub degradacja mRNA", "Cytoplazma"],
              ["siRNA (małe interferujące)", "Wyciszanie ekspresji genów (interferencja RNA — RNAi)", "Cytoplazma"],
            ],
          },
        ],
        recallQuestions: [
...
// ============================================================
// CKE EXAM QUESTIONS — grouped strictly at the bottom
// ============================================================
