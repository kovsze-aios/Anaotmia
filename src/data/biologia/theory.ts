...
export const biologiaTheory: TextbookDomain[] = [
  {
    ...
    "sections": [
      ...
      {
        "id": "cke-questions-grouped-cytologia",
  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "academic_detail": "DNA (kwas deoksyrybonukleinowy) jest nośnikiem informacji genetycznej. Struktura podwójnej helisy (Watson i Crick, 1953, z wykorzystaniem danych Rosalind Franklin): dwie antyrównoległe nici (5′→3′ i 3′→5′) skręcone prawoskrętnie wokół wspólnej osi. Każda nić zbudowana jest z nukleotydów: cukier deoksyryboza, reszta fosforanowa(V) i zasada azotowa. Zasady purynowe: adenina (A) i guanina (G) — dwupierścieniowe. Zasady pirymidynowe: tymina (T — tylko w DNA) i cytozyna (C) — jednopierścieniowe. Komplementarność: A=T (2 wiązania wodorowe), C≡G (3 wiązania wodorowe — silniejsze). Szkielet cukrowo-fosforanowy tworzy łącznik między nukleotydami (wiązania fosfodiestrowe 3′→5′). U eukariontów DNA jest upakowany w chromatynę: owija się wokół oktamerów histonowych (po 2 cząsteczki H2A, H2B, H3, H4) tworząc nukleosomy (średnica ~11 nm), które dalej kondensują do włókna 30 nm (solenoid), a następnie w wyższe rzędy upakowania aż do chromosomu metafazowego.\n\nDodatkowe informacje ze źródeł:\ndna, może być\nlat temu mogą nie być zgodne\n31\nczęścią żartobliwej lub satyrycznej\nz aktualną wiedzą naukową. Nawet\nwypowiedzi. Przeanalizuj dokładnie,\nartykuły naukowe opublikowane\nskąd pochodzi informacja. Jeżeli\nw cenionych czasopismach\nzostała zamieszczona na stronie\nnaukowych wiele lat temu mogą\ninternetowej lub w gazecie,\nzawierać informacje dzisiaj uznane\nsprawdź ich opisy.\nza nieprawdziwe.\nPrzeczytaj artykuł do końca\nZapytaj ekspertów\nCzęsto nagłówki artykułów\nZapytaj ekspertów, np. nauczyciela,\nSZOK!\nsą formulowane w sposób\nczy odnalezione przez Ciebie\nprowokacyjny, aby skłonić odbiorcę\nwiadomości są rzetelne.\ndo dalszej lektury. Mogą one nawet\nzawierać fałszywe informacje,\nsprzeczne z treścią artykułu,\ndlatego czytaj teksty w całości,\nSprawdź, kim jest autor tekstu\nnie tylko nagłówki. Zwłaszcza że\nPoszukaj informacji o autorze tek-\nniektóre artykuły mają charakter\nstu lub twórcach strony. Upewnij\nprześmiewczy, o czym autorzy\nsię, czy w ogóle istnieją i czy są\nczęsto informują na samym końcu.\nwiarygodni.\nWyszukaj informacje na dany temat\nw innych źródłach\nSpróbuj wyszukać podane informacje\nw artykułach i publikacjach naukowych.\nMożesz wykorzystać do tego celu\nwyszukiwarki internetowe, takie jak\nGoogle Scholar lub Pubmed. Pamiętaj,\nże najrzetelniejsze informacje naukowe\nuzyskasz z artykułów naukowych\npublikowanych w czasopismach\nnaukowych. Przykładami najbardziej\nznanych czasopism biologicznych są\n\"Nature\" oraz Science\".\n9\n\n--- STRONA 10 ---\nRozdział 1. Badania przyrod...",
        "content": [
          {
            "type": "paragraph",
      ...
      {
        "id": "cke-questions-grouped-genetyka",
        "title": "Pytania Maturalne CKE",
        "summary": "- Zbiorcze zestawienie pytań maturalnych **CKE** dla tego działu.\n- Przeznaczone do ułatwienia powtórki przed __________.",
        "academic_detail": "Pytania zostały zgrupowane ze wszystkich podsekcji dla łatwiejszej powtórki do matury z biologii i chemii.",
        "content": [],
  ...
  },
  {
    ...
    "sections": [
      ...
      {
        "id": "cke-questions-grouped-metabolizm",
        "title": "Pytania Maturalne CKE",
        "summary": "- Zbiorcze zestawienie pytań maturalnych **CKE** dla tego działu.\n- Przeznaczone do ułatwienia powtórki przed __________.",
        "academic_detail": "Pytania zostały zgrupowane ze wszystkich podsekcji dla łatwiejszej powtórki do matury z biologii i chemii.",
        "content": [],
    ...
    "sections": [
      {
        ...
        "academic_detail": "Rośliny nasienne (Spermatophyta) dzielą się na nagonasienne (Gymnospermae) i okrytonasienne (Angiospermae — jednoliścienne i dwuliścienne). Ich budowa jest przystosowaniem do życia na lądzie: wykształciły tkanki okrywające (epiderma z kutykulą, aparaty szparkowe), wzmacniające (kolenchyma, sklerenchyma), przewodzące (ksylem i floem) oraz miękiszowe. Tkanki twórcze (merystemy) dzielą się na pierwotne (stożki wzrostu pędu i korzenia, merystem interakalarny — u traw, merystem archesporialny — w zalążkach i woreczkach pyłkowych) oraz wtórne (kambium — miazga twórcza, fellogen — miazga korkotwórcza), umożliwiające przyrost wtórny na grubość.\n\nDodatkowe informacje ze źródeł:\nroślin.\n14\n\n--- STRONA 15 ---\n1.1. Metodyka badań biologicznych\nPrzykładowa obserwacja\nUczniowie pewnej szkoły wzięli udział w akcji przenoszenia płazów przez ruchliwy odcinek\ndrogi. Przy okazji uczniowie postanowili sprawdzić, ile płazów próbuje przedostać się\nprzez drogę na tym odcinku i do jakich gatunków one należą.\nS\ne\nProblem badawczy: Ile płazów próbuje przedostać się przez drogę na określonym\nodcinku i do jakich gatunków one należą?\nPostawienie hipotezy: Z literatury uczniowie dowiedzieli się, że na terenie objętym akcją\na\nżyją następujące gatunki płazów:\nŻaba trawna\nRopucha szara\nGrzebiuszka ziemna\n(Rana temporaria)\n(u buro)\n(Pelobates fuscus)\nHipoteza: Na badanym odcinku drogi liczba wędrujących płazów jest różna w zależno-\nści od gatunku.\nWeryfikacja hipotezy: Uczniowie określili obiekt oraz cel badań, miejsce, czas i często-\ntliwość prowadzenia obserwacji, a także sposób jej prowadzenia i dokumentowania (dane\nte znajdują się w zamieszczonej poniżej tabeli). Po przeprowadzeniu obserwacji uczniowie\nzapisali wyniki, a następnie je przeanalizowali. Na podstawie wyników stwierdzili, że\nmigruje najwięcej ropuch szarych, a najmniej grzebiuszek ziemnych. Postawiona hipoteza\nzostała potwierdzona.\nPrawidłowo zaplanowana obserwacja\nElement\nObserwacja\nobserwacji\nObiekt badań\nPrzedstawiciele płazów: żaba trawna (Rana temporaria), ropucha szara (Bufo bufo)\ni grzebiuszka ziemna (Pelobates fuscus).\nCel badań\nOkreślenie gatunków i liczby płazów, które przemieszczają się przez drog...",
        "content": [
          {
            "type": "paragraph",
      ...
      {
        "id": "cke-questions-grouped-botanika",
        "title": "Pytania Maturalne CKE",
        "summary": "- Zbiorcze zestawienie pytań maturalnych **CKE** dla tego działu.\n- Przeznaczone do ułatwienia powtórki przed __________.",
        "academic_detail": "Pytania zostały zgrupowane ze wszystkich podsekcji dla łatwiejszej powtórki do matury z biologii i chemii.",
        "content": [],
    ...
    "sections": [
      {
        ...
        "academic_detail": "Homeostaza to zdolność organizmu do utrzymywania stałości środowiska wewnętrznego (temperatura ~37°C, pH krwi 7,35-7,45, stężenie glukozy 70-110 mg/dL na czczo, ciśnienie krwi 120/80 mmHg, osmolalność ~290 mOsm/kg H₂O) mimo zmian w otoczeniu. Mechanizmy homeostatyczne działają na zasadzie ujemnego sprzężenia zwrotnego (np. regulacja glikemii, termoregulacja) lub dodatniego (np. skurcze porodowe — oksytocyna, potencjał czynnościowy). Układ hormonalny i nerwowy współpracują w podtrzymywaniu homeostazy.\n\nDodatkowe informacje ze źródeł:\nukład\ncących kolorach. Do obserwacji tych struktur\nszklanych soczewek, które je załamują. Dzięki\nwykorzystuje się specjalny rodzaj mikroskopu\ntemu widziany obraz jest powiększony.\noptycznego – mikroskop fluorescencyjny.\nSamouczek\nPrzeliczanie jednostek długości\nJeśli mikroskop optyczny powiększa obraz\nPrzeliczanie jednostek długości:\n1000-krotnie oznacza to, że obiekt, który na obra-\n1 m = 100 cm = 1000 mm\nzie uzyskanym pod mikroskopem ma wielkość\n1 mm = 1000 μm = 10-3 m\n1 cm, w rzeczywistości mierzy 1000-razy mniej,\n1 μm = 1000 nm = 10-6 m\nczyli 0,001 cm, co odpowiada 0,01 mm lub 10 μm.\n1 nm = 1000 μm = 10⁻9 m\n17\n\n--- STRONA 18 ---\nBudowa i zasada działania mikroskopu optycznego\nBudowa mikroskopu optycznego\nMik n  w y     z oego\nmeo o a   o o s o  ozazu\nUkład mechaniczny umożliwia m.in. przesuwanie części optycznych względem preparatu.\nElementy układu\nElementy układu\nmechanicznego mikroskopu:\noptycznego mikroskopu:\nTubus utrzymuje we właściwym\nOkular zawiera soczewkę,\npołożeniu soczewki mikroskopu.\ndzięki której uzyskuje się\npowiększenie obrazu, oraz\nRewolwer umożliwia zmianę\numożliwia obserwację.\nobiektywu, a tym samym\nwielkości powiększenia.\nObiektyw zawiera\nsoczewkę, dzięki której\nStolik jest miejscem, na którym\nuzyskuje się powiększenie\numieszcza się preparat.\nobrazu.\nŚruba makrometryczna\nKondensor skupia\npodnosi lub opuszcza\nwiązkę światła.\nstolik względem obiektywu.\nSłuży do odnalezienia\nŻródło światła zapewnia\nobrazu pod najmniejszym\noświetlenie preparatu.\npowiększeni...",
        "content": [
          {
            "type": "paragraph",
      ...
      {
        "id": "cke-questions-grouped-czlowiek",
        "title": "Pytania Maturalne CKE",
        "summary": "- Zbiorcze zestawienie pytań maturalnych **CKE** dla tego działu.\n- Przeznaczone do ułatwienia powtórki przed __________.",
        "academic_detail": "Pytania zostały zgrupowane ze wszystkich podsekcji dla łatwiejszej powtórki do matury z biologii i chemii.",
        "content": [],
