    ...
    sections: [
      {
        ...
        content: [
          ...
          {
            type: "table",
            headers: ["Liczba", "Symbol", "Znaczenie"],
            rows: [
              ["Główna kwantowa", "n = 1, 2, 3…", "Numer powłoki (K, L, M…), energia orbitalu"],
              ["Poboczna (orbitalna)", "l = 0…(n−1)", "Typ orbitalu: s=0, p=1, d=2, f=3"],
              ["Magnetyczna", "m = −l…+l", "Orientacja przestrzenna orbitalu"],
              ["Spinowa", "ms = +½, −½", "Kierunek spinu elektronu"],
            ],
          },
        ],
        recallQuestions: [
