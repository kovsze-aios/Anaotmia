...
export const chemiaTheory: TextbookDomain[] = [
    ...
    "sections": [
      {
        ...
        "academic_detail": "Mol jest jednostką liczności materii w układzie SI. Jeden mol zawiera dokładnie 6,02214076 × 10²³ obiektów elementarnych (liczba Avogadra NA). Jeden mol atomów pierwiastka zawiera NA atomów, jeden mol cząsteczek związku chemicznego zawiera NA cząsteczek. Masa molowa (M) to masa 1 mola substancji, wyrażona w g/mol — liczbowo równa masie atomowej (dla pierwiastków, podawana w unitach u) lub masie cząsteczkowej (dla związków, suma mas atomowych). Przykład: M(H₂O) = 2 × 1,008 + 16,00 = 18,02 g/mol. Liczba moli n = m/M, gdzie m to masa w gramach.\n\nDodatkowe informacje ze źródeł:\nmasa atomowa, izotopy, nuklidy, przemiana jądrowa, prze-\nmiana α, przemiana β-, β+, cząstka a, cząstka β, szereg promieniotwórczy, okres półtrwania,\nliczba kwantowa (główna, poboczna, magnetyczna, magnetyczna spinowa), konfiguracja\nelektronowa, elektrony walencyjne, powłoka elektronowa, podpowłoka elektronowa (s, p, d),\norbital atomowy, okres, grupa, jon prosty.\nZadanie 1.1. [CKE, matura, maj 2010, zad. 1. (1 pkt)]\nAtomy pierwiastka X tworzą jony X3+, których konfigurację elektronową można zapisać:\n1s2s22p63s²3p63d10\nUzupełnij poniższą tabelę, wpisując symbol pierwiastka X, dane dotyczące jego położenia\nw układzie okresowym oraz symbol bloku konfiguracyjnego (energetycznego) s, p lub d,\ndo którego należy pierwiastek X.\nSymbol pierwiastka\nNumer okresu\nNumer grupy\nSymbol bloku\nZadanie 1.2. [CKE, matura, maj 2010, zad. 2. (2 pkt)]\nJednym z pierwszych sztucznie otrzymanych radionuklidów był izotop azotu 3N. Powstał on\nw wyniku napromieniowania izotopu boru 0 B cząstkami α pochodzącymi z naturalnej prze-\nmiany promieniotwórczej, jakiej ulega izotop polonu 210 Po.\nNapisz równania przemian promieniotwórczych opisanych powyżej.\nZadanie 1.3. [CKE, matura, maj 2011, zad. 1. (2 pkt)]\nPewien pierwiastek X tworzy anion prosty o konfiguracji elektronowej atomu argonu. W stanie\npodstawowym w powłoce walencyjnej atomu pierwiastka X dwa orbitale p mają niesparowane\nelektrony.\nNapisz symbol pierwiastka X oraz podaj konfigurację elektronową powloki walencyjnej\natomu tego pierwiastka.\nInformacja...",
        "content": [
          {
            "type": "paragraph",
      ...
      {
        "id": "cke-questions-grouped-stechiometria",
        "title": "Pytania Maturalne CKE",
        "summary": "- Zbiorcze zestawienie pytań maturalnych **CKE** dla tego działu.\n- Przeznaczone do ułatwienia powtórki przed __________.",
        "academic_detail": "Pytania zostały zgrupowane ze wszystkich podsekcji dla łatwiejszej powtórki do matury z biologii i chemii.",
        "content": [],
  ...
  },
  {
    ...
    "sections": [
      ...
      {
        "id": "cke-questions-grouped-nieorganiczna",
        "title": "Pytania Maturalne CKE",
        "summary": "- Zbiorcze zestawienie pytań maturalnych **CKE** dla tego działu.\n- Przeznaczone do ułatwienia powtórki przed __________.",
        "academic_detail": "Pytania zostały zgrupowane ze wszystkich podsekcji dla łatwiejszej powtórki do matury z biologii i chemii.",
        "content": [],
  ...
  },
  {
    ...
    "sections": [
      ...
      {
        "id": "cke-questions-grouped-organiczna",
        "title": "Pytania Maturalne CKE",
        "summary": "- Zbiorcze zestawienie pytań maturalnych **CKE** dla tego działu.\n- Przeznaczone do ułatwienia powtórki przed __________.",
        "academic_detail": "Pytania zostały zgrupowane ze wszystkich podsekcji dla łatwiejszej powtórki do matury z biologii i chemii.",
        "content": [],
