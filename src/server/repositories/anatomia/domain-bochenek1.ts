...
import { bochenek1Chapters } from "@/data/anatomia/tomy";
...
export const bochenek1Domain: TextbookDomain = {
  id: "bochenek-tom-1-anatomia-ogolna-uklad-ruchu",
  title: "Kompendium: Anatomia Ogólna, Kości, Stawy i Mięśnie (Bochenek)",
  shortTitle: "Kompendium Tom 1",
  icon: "📚",
  sections: bochenek1Chapters.map(mapToSection),
};
