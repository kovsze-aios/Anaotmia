    ...
    <>
      ...
      >
        <div className="mobile-drawer__header">
          ...
          <button className="mobile-drawer__close focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-400 dark:focus-visible:ring-zinc-600" onClick={onClose} aria-label="Zamknij menu">✕</button>
        </div>
